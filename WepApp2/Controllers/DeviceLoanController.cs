...
{
    public class DeviceLoanController : Controller
    {
        private readonly InnvoationLabDbgroup2Context _context;

        public DeviceLoanController(InnvoationLabDbgroup2Context context)
        {
            _context = context;
        }

        // GET: عرض الأجهزة المرتبطة بخدمة الإعارة
        ...
        // POST: إضافة جهاز للإعارة (يستقبل serviceId و deviceId مباشرة)
        [HttpPost]
        ...
        // POST: حذف جهاز من الإعارة (يستقبل serviceId و deviceId مباشرة)
        [HttpPost]
        [ValidateAntiForgeryToken]
